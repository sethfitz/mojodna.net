...
*Cross-posted from [openterrain.tumblr.com](https://openterrain.tumblr.com/post/109330474336/resolved-gdal-on-aws-gpu-instances).*

Specifically, `g2.2xlarge` instances with Nvidia GRID K520 GPUs running Amazon Linux.

As we kicked off the [new Knight News
Grant](https://content.stamen.com/new_knight_grant_new_toner_new_infrastructure),
...
cd /tmp
curl -L https://download.osgeo.org/gdal/1.11.1/gdal-1.11.1.tar.gz | tar zxf -
cd gdal-1.11.1
